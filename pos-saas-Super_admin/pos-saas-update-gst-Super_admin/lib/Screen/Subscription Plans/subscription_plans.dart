...
class _SubscriptionPlansState extends State<SubscriptionPlans> {
  ...
  Widget build(BuildContext context) {
    ...
    bool isMobileScreen=rf.ResponsiveValue<bool>(
      context,
      defaultValue: false,
      conditionalValues: [
    ...
    bool isTabScreen=rf.ResponsiveValue<bool>(
        context,
        defaultValue: false,
        conditionalValues: [
    ...
    final kWidth= isMobileScreen?MediaQuery.of(context).size.width/1.2:isTabScreen?MediaQuery.of(context).size.width/2.2:MediaQuery.of(context).size.width/6;

    final screenTextSize=rf.ResponsiveValue<bool>(
      context,
      defaultValue: false,
      conditionalValues: [
    ...
    final kPlanButton=rf.ResponsiveValue<bool>(
        context,
        defaultValue: false,
        conditionalValues: [
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            GlobalTransparentButton(
                                buttonText: screenTextSize?kPlanButton?'Plan':'New Plan': 'Subscription Plan',
                        ...
                        GridView.builder(
                          ...
                          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                              ...
                              crossAxisSpacing: 16,
                              mainAxisSpacing: 16,
                              crossAxisCount: isMobileScreen?1:isTabScreen?2:4),
                                ...
                                children: [
                                  Stack(
                                    ...
                                    children: [
                                      Container(
                                        height: 296,
                                        width: isMobileScreen?MediaQuery.of(context).size.width/1.4:isTabScreen?MediaQuery.of(context).size.width/2.2:MediaQuery.of(context).size.width/4.2,
                                        decoration: BoxDecoration(
