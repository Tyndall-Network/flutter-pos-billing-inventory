...
import '../../static_string/static_string.dart';
...
class InfoWidget extends StatelessWidget {
  const InfoWidget(
      ...
      this.arrowIcon,
      this.arrowIconColor, required this.bgColor, this.height})
      : super(key: key);
  ...
  @override
  Widget build(BuildContext context) {
    final tabAndPhoneSize = MediaQuery.of(context).size.width<1200;
    return Card(
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(4.0)),
      elevation: 0.0,
      shadowColor: kGreyTextColor,
      child: Container(
        height:tabAndPhoneSize?142:170,
        padding: const EdgeInsets.all(10),
        decoration: BoxDecoration(
          ...
          children: [
            ...
            Row(
              children: [
                ...
                const SizedBox(width: 4.0),
                Flexible(child: Text(currentYear, style: kTextStyle.copyWith(color: kTitleColor, fontWeight: FontWeight.bold), overflow: TextOverflow.ellipsis,maxLines: 1,))
              ],
            ),
          ],
        ),
...
class YearlyInfoWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final tabAndPhoneSize = rf.ResponsiveValue<bool>(context,
        defaultValue: false,
        conditionalValues: [
    ...
    return Card(
      ...
      shadowColor: kGreyTextColor,
      child: Container(
        height:tabAndPhoneSize?142:161,
        padding: const EdgeInsets.all(10),
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(4.0),
          color: bgColor,
          ...
          children: [
            ...
            Row(
              children: [
                ...
                const SizedBox(width: 4.0),
                Flexible(child: Text(currentYear, style: kTextStyle.copyWith(color: kTitleColor, fontWeight: FontWeight.bold), overflow: TextOverflow.ellipsis))
              ],
            ),
          ],
        ),
