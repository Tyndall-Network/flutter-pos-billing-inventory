                                              ...
                                              child: DataTable(
                                                ...
                                                columns: [
                                                  ...
                                                  DataColumn(
                                                      label: Flexible(
                                                          child:
                                                              Text(lang.S.of(context).partyName, style: kTextStyle.copyWith(color: kTitleColor, overflow: TextOverflow.ellipsis)))),
                                                  DataColumn(
                                                      label: Flexible(
                                                          child:
                                                              Text(lang.S.of(context).partyType, style: kTextStyle.copyWith(color: kTitleColor, overflow: TextOverflow.ellipsis)))),
                                                  DataColumn(
